...
sns.scatterplot(data=rules, x='support', y='confidence', size='lift', hue='lift', sizes=(50, 400), palette='viridis', alpha=0.8)
...
plt.figure(figsize=(10, 6))
sns.barplot(data=top_10_lift, x='lift', y='Regra', hue='Regra', palette='magma', legend=False)
...
sns.heatmap(co_matrix, cmap='Blues', annot=True, fmt='d', linewidths=0.5, cbar_kws={'label': 'Número de Pokémons com ambos os tipos'})
